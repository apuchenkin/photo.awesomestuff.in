  ...
  render() {
    return (
      <div className="error-404">
        ...
        <p><FormattedMessage id="error.404.text" defaultMessage={`Page "{url}" that you were looking for, cannot be found.`} values={{url: this.props.location.pathname}} /></p>
        ...
        <p><FormattedMessage id="error.404.contactText"
          defaultMessage={`Please, {link} if you're followed a broken link`}
          values={{link: <Link to="/contacts" style={{margin: 0}}><FormattedMessage id="error.404.contact" defaultMessage={`contact us`}
          /></Link>}} /></p>
